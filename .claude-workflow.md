...
│   │   ├── FileDecorationProvider.ts # "M" badge on modified files
...
- `src/providers/HostTreeProvider.test.ts` — Server grouping, tree items, icons, credentials, pinned folders (~25 tests)

...
module.exports = {
  ...
  testPathIgnorePatterns: ['/node_modules/', 'docker-ssh.*\\.test\\.ts', 'docker-ftp.*\\.test\\.ts', 'multi-os-ssh\\.test\\.ts', 'multios-.*\\.test\\.ts', 'src/chaos/chaos[^/\\\\]*\\.test\\.ts$', 'windows-client\\.test\\.ts'],

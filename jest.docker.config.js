...
module.exports = {
  ...
  roots: ['<rootDir>/src'],
  testMatch: ['**/docker-ssh.test.ts', '**/docker-ssh-tools.test.ts', '**/docker-ssh-sudo.test.ts', '**/docker-ssh-download.test.ts', '**/docker-ssh-collision.test.ts', '**/docker-ssh-reveal.test.ts', '**/docker-ssh-listing-failure.test.ts', '**/docker-ssh-image-open.test.ts'],
